<x-app-layout>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
            <x-card>
                <div class="p-6">
                    <form action="{{ route('admin.coupon.store') }}" method="POST" class="space-y-6">
                        @csrf
                        
                        <!-- Code -->
                        <div class="space-y-2">
                            <x-label for="code">Coupon Code</x-label>
                            <x-input id="code" name="code" type="text" value="{{ old('code') }}" required autofocus class="uppercase" />
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <x-input id="value" name="value" type="number" step="0.01" min="0" value="{{ old('value') }}" required />
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-2">
                                ...
                                <x-input id="min_order_amount" name="min_order_amount" type="number" step="0.01" min="0" value="{{ old('min_order_amount') }}" />
                                @error('min_order_amount') <p class="mt-1 text-sm text-destructive">{{ $message }}</p> @enderror
                            </div>
                            <div class="space-y-2">
                                <x-label for="max_discount">Maximum Discount (฿) (For Percentage)</x-label>
                                <x-input id="max_discount" name="max_discount" type="number" step="0.01" min="0" value="{{ old('max_discount') }}" />
                        ...
                        <div class="space-y-2">
                            ...
                            <x-input id="usage_limit" name="usage_limit" type="number" min="1" value="{{ old('usage_limit') }}" />
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-2">
                                ...
                                <x-input id="starts_at" name="starts_at" type="datetime-local" value="{{ old('starts_at') }}" />
                            ...
                            <div class="space-y-2">
                                ...
                                <x-input id="expires_at" name="expires_at" type="datetime-local" value="{{ old('expires_at') }}" />
                        ...
                        <div class="flex items-center space-x-2">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="w-4 h-4 border-gray-300 rounded text-primary focus:ring-primary">
                        ...
                        <div class="flex justify-end pt-4 space-x-4">
                            ...
                            <x-button type="submit">Create Coupon</x-button>
                        </div>
                    </form>
                </div>
            </x-card>
