                ...
                <div class="p-6">
                    <form action="{{ route('admin.menu.update', $menu) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <x-input id="name" name="name" type="text" value="{{ old('name', $menu->name) }}" required autofocus />
                        ...
                        <div class="space-y-2">
                            ...
                            <x-textarea id="description" name="description" rows="3">{{ old('description', $menu->description) }}</x-textarea>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-2">
                                ...
                                <x-input id="price" name="price" type="number" step="0.01" min="0" value="{{ old('price', $menu->price) }}" required />
                            ...
                            <div class="space-y-2">
                                ...
                                <x-input id="prep_time_minutes" name="prep_time_minutes" type="number" min="0" value="{{ old('prep_time_minutes', $menu->prep_time_minutes) }}" />
                        ...
                        <!-- Image -->
                        <div class="space-y-2">
                            <x-label for="image">Menu Image (Leave blank to keep current)</x-label>
                            @if($menu->image_url)
                                <div class="mb-2">
                                    <img src="{{ $menu->image_url }}" alt="Current Image" class="object-cover w-20 h-20 rounded-md shadow">
                                </div>
                            @endif
                        ...
                        <div class="flex items-center space-x-6">
                            <label class="flex items-center space-x-2">
                                <input type="checkbox" name="is_available" value="1" {{ old('is_available', $menu->is_available) ? 'checked' : '' }} class="text-primary rounded border-gray-300 focus:ring-primary h-4 w-4">
                                <span class="text-sm font-medium leading-none text-gray-700 dark:text-gray-300">Available</span>
                            </label>
                            <label class="flex items-center space-x-2">
                                <input type="checkbox" name="is_popular" value="1" {{ old('is_popular', $menu->is_popular) ? 'checked' : '' }} class="text-primary rounded border-gray-300 focus:ring-primary h-4 w-4">
                        ...
                        <div class="flex justify-end pt-4 space-x-4">
                            ...
                            <x-button type="submit">Update Menu Item</x-button>
                        </div>
                    </form>
                </div>
            </x-card>
